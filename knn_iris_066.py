...
def load_dataset(name, features, test_size):
    ...
    return train_test_split(X, Y, test_size=test_size, random_state=333)
...
if __name__ == '__main__':
    ...
    x_train, x_test, y_train, y_test = load_dataset("iris",features, 0.66)
    ...
    # Construct plot
    plt.title('Petal Length/Width, 0.66 split')
